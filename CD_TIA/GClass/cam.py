...
def main():
    ...
    pretrained_file = "OnlyChangModel/data_model_50.pth"  # 2-class
    model = ResNet()
    ...
    target_layers = [model.layer3, model.layer2, model.layer1]
   # print(target_layers.shape)
    # target_layers = target_layers[0]
    data_transform = transforms.Compose([transforms.ToTensor(),
                                         transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
    # load image
    # img_path = "21_32.jpg"
    image_path = r"/disk/sdc/data/ill"
    save_path = r"/disk/sdc/epoch50"
